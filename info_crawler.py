...
# browser.install_addon("web-extensions/uBlock-Origin.crx", temporary=True)
...
for id_liceu, nume_liceu in tqdm(licee):
    ...
    #     website = urllib.parse.urlparse(
    #         browser.execute_script(
    #             "let o = document.querySelector(\"[data-tooltip='Deschide site-ul']\"); return o ? o.href : null"
    #         )
    #     ).netloc
